...
public class BlurTextureCreator : MonoBehaviour
{
    ...
    public static RenderTexture BlurredTexture
    {
        get
        {
            ...
            int rtWidth = (int) (NGUITools.screenSize.x/8);
            int rtHeight = (int) (NGUITools.screenSize.y/8);
...
//                 }
//             }
            var screen = ResourceManager.Instance.getScreenRenderTexture();
...
//             {
//                 var rtc = UICamera.currentCamera.GetComponent<RenderTextureCreator>();
//                 if (null != rtc)
//                 {
//                     rtc.BindCamera();
//                 }
