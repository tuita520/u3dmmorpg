...
public class TargetBindingProperty
{
    ...
    public static void SetLabelGradientBottom(object obj, object value)
    {
        ((UILabel)obj).gradientBottom = (Color)value;
    }
...
//         });
        ...
        property = typeof(UILabel).GetProperty("gradientBottom");
        RegisterPropertySetter(property, SetLabelGradientBottom);
    }
    ...
    public Type GetPropertyType()
    {
        ...
        if (mProperty != null)
        {
            mTargetValueType = mProperty.PropertyType;
            return mTargetValueType;
        }
        if (mField != null)
        {
            mTargetValueType = mField.FieldType;
            return mTargetValueType;
        }
#endif
#if UNITY_EDITOR || !UNITY_FLASH
    ...
    public bool Set(object value)
    {
        ...
        if (value == null)
        {
            ...
            {
                Debug.LogError("SetValue Error" + ex.ToString());
            }
        }
