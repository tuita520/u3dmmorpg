...
catch (Exception ex)
{
    ...
    public override void StartAttributeSync()
    {
        ...
        NetManager.Instance.SyncCenter.RequestSyncData(ServiceType.Scene, characterId, (uint)eSceneSyncId.SyncPlayerName,
           (string name) => { 
               Name = name;
               OnNameBoardRefresh();
           });
        ...
        NetManager.Instance.SyncCenter.RequestSyncData(ServiceType.Scene, characterId, (uint) eSceneSyncId.SyncTitle3,
            (int i) => { SetTitle(3, i); });
        NetManager.Instance.SyncCenter.RequestSyncData(ServiceType.Scene, characterId, (uint)eSceneSyncId.SyncTitle4,
            (int i) => { SetTitle(4, i); });
    ...
    public override void StopAttributeSync()
    {
        ...
        NetManager.Instance.SyncCenter.StopSyncData(ServiceType.Scene, characterId, (uint)eSceneSyncId.SyncTitle4);
