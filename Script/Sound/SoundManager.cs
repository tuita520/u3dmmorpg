...
public class SoundManager : MonoBehaviour, IManager
{
    ...
    public bool VoicePlaying
    {
        set
        {
            ...
            if (value)
            {
	            ...
	            SetAreaSoundEnable(false);
            }
            else
            {
                mBGAudioSource.m_AudioSource.mute = false;
				SetAreaSoundEnable(true);
            }
        }
    }
    ...
    public void SetAreaSoundEnable(bool enable)
    {
    ...
    public void StopBGM(float _fadeTime=0.2f)
    {
        if (mEnableBGM)
        {
