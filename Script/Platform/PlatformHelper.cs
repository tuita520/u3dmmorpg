...
public class PlatformHelper
{
	...
	public static void PlayLogoMovie()
	{
		...
		#endif
		GameUtils.RecordKeyPoint("PlayLogoMovie", 4);
	}
	...
	//        {
	//            Logger.Debug(sharedsdktools.MiniJSON.jsonEncode(result));
	//            PlayerDataManager.Instance.SetFlag(559);
	//            var list = new Int32Array();
	//            list.Items.Add(559);
	//            PlayerDataManager.Instance.SetFlagNet(list);
    ...
    public static void InitTalkingDataWithChannelId(string str)
    {
#if UNITY_EDITOR

#elif UNITY_ANDROID
                AndroidHelper.platformHelper("InitTalkingDataWithChannelId", str);
#elif UNITY_IOS
	...
	public static void CollectionEnterGameDataForKuaifa(string roleId, string roleName, int roleLevel, string serverId, string serverName, int viplevel, string partName, string createTime, string diamond, string timeLevelup)
	{
        ...
        writer.Write(PlayerDataManager.Instance.UidForPay);
		...
		writer.WritePropertyName("diamond");
		writer.Write(diamond);
		writer.WritePropertyName("time");
		writer.Write(timeLevelup);
	...
	public static void CollectionLevelUpDataForKuaifa(int roleLevel, string time, string diamond)
	{
		System.Text.StringBuilder sb = new System.Text.StringBuilder();
		JsonWriter writer = new JsonWriter(sb);
		writer.WriteObjectStart();
	...
	{
		#if UNITY_ANDROID && !UNITY_EDITOR
		AndroidHelper.platformHelper("UpdateUrl", url);
		#endif
	}
...
// 		#if USETYPESDK
// 		TypeSDKHelper.Instance.SetLocalPush(key, message, timeInterval);
// 		return;
// 		#endif
		System.Text.StringBuilder sb = new System.Text.StringBuilder();
		JsonWriter writer = new JsonWriter(sb);
	...
	{
// 		#if USETYPESDK
// 		TypeSDKHelper.Instance.DeleteLocalPush(key);
// 		return;
// 		#endif
		System.Text.StringBuilder sb = new System.Text.StringBuilder();
		JsonWriter writer = new JsonWriter(sb);
	...
	{
// #if USETYPESDK
// 		TypeSDKHelper.Instance.ClearAllPush();
// 		return;
// #endif
...
//	public static extern string  GetDeviceName();
	...
	[DllImport("__Internal")]
	public static extern void UserLogin();
	
	[DllImport("__Internal")]
	public static extern void MakePayWithGoodInfo(string info);
	
	[DllImport("__Internal")]
	public static extern void Exit();
	
	[DllImport("__Internal")]
	public static extern void ChangeAccount();
	
	[DllImport("__Internal")]
	public static extern void UserLogout();
	
	[DllImport("__Internal")]
	public static extern void  SetUserInfo(string info);
    ...
    public static bool IsIphoneX()
    {
		...
		Logger.Debug("DeviceModel is "+model);
		return model.Equals ("iPhone10,3") || model.Equals ("iPhone10,6");
    }
}
