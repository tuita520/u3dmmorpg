...
public static class Logger
{
    ...
    public static void Debug(string message, params object[] args)
    {
        if (LogLevel <= LogLevelType.Debug)
        {
            ...
            {
                UnityEngine.Debug.Log("[Debug] LOGERROR " + message);
            }
        }
    }
    ...
    public static void Info(string message, params object[] args)
    {
        if (LogLevel <= LogLevelType.Info)
        {
            ...
            {
                UnityEngine.Debug.Log("[Info] LOGERROR " + message);
            }
        }
    }
    ...
    public static void Warn(string message, params object[] args)
    {
        if (LogLevel <= LogLevelType.Warning)
        {
            ...
            {
                UnityEngine.Debug.Log("[Warning] LOGERROR " + message);
            }
        }
    }
    ...
    public static void Error(string message, params object[] args)
    {
        if (LogLevel <= LogLevelType.Error)
        {
            ...
            {
                UnityEngine.Debug.Log("[Error] LOGERROR " + message);
            }
        }
    }
    ...
    public static void Fatal(string message, params object[] args)
    {
        if (LogLevel <= LogLevelType.Fatal)
        {
            ...
            {
                UnityEngine.Debug.Log("[Fatal] LOGERROR " + message);
            }
        }
    }
