...
namespace ClientService
{
	...
	public interface IScene9xServiceInterface : IAgentBase
    {
        ...
        /// 通知客户端，开启xp技能引导
        /// </summary>
        void NotifyStartXpSkillGuide(int placeholder);
        /// <summary>
        /// 通知客户端，开启玛雅武器副本引导
        /// </summary>
        void NotifyStartMaYaFuBenGuide(int type);
        /// <summary>
        /// 服务端广播爬塔怪物个数
        /// </summary>
        void BroadcastSceneMonsterCount(int count);
        /// <summary>
        ...
        /// </summary>
        void NotifyTeamMemberScene(ulong characterId, ulong changeCharacterId, ulong sceneId);
        /// <summary>
        /// 强制停止移动
        /// </summary>
        void ForceStopMove(PositionData pos);
        /// <summary>
        /// 同步倒计时
        /// </summary>
        void NotifyCommonCountdown(int time);
        /// <summary>
        /// 吃鸡玩法通知客户端升级
        /// </summary>
        void CK_NotifyClientLevelup(ulong objId, int lv, int exp, Dict_int_int_Data addBuff);
        /// <summary>
        /// 发送吃鸡地图信息
        /// </summary>
        void CK_NotifyCheckenSceneInfo(MsgCheckenSceneInfo info);
        /// <summary>
        /// 发送收到地图伤害
        /// </summary>
        void CK_NotifyHurt(int placeholder);
        /// <summary>
        /// </summary>
        void CK_NotifyRankList(MsgCheckenRankList rank);
        /// <summary>
        /// 同步模型Id
        /// </summary>
        ...
        /// <summary>
        /// </summary>
        void NotifyLodeInfo(MsgSceneLode info);
        /// <summary>
        /// </summary>
        void NotifyPlayEffect(int effectId);
    }
    public static class Scene9xServiceInterfaceExtension
    {
        ...
        public static MoveToOutMessage MoveTo(this IScene9xServiceInterface agent, int sceneId, Vec2Array targetList, float offset, long time)
        {
            return new MoveToOutMessage(agent, sceneId, targetList, offset, time);
        }

        public static StopMoveOutMessage StopMove(this IScene9xServiceInterface agent, int sceneId, PositionData pos)
        {
            return new StopMoveOutMessage(agent, sceneId, pos);
        }
        ...
        public static SendUseSkillRequestOutMessage SendUseSkillRequest(this IScene9xServiceInterface agent, int sceneId, CharacterUseSkillMsg msg)
        {
            return new SendUseSkillRequestOutMessage(agent, sceneId, msg);
        }
        ...
        public static SummonMonsterOutMessage SummonMonster(this IScene9xServiceInterface agent, int monsterId)
        {
            return new SummonMonsterOutMessage(agent, monsterId);
        }
        ...
        public static CK_ApplyLevelupBuffOutMessage CK_ApplyLevelupBuff(this IScene9xServiceInterface agent, int buffId)
        {
            return new CK_ApplyLevelupBuffOutMessage(agent, buffId);
        }

        public static ApplySolveStuckOutMessage ApplySolveStuck(this IScene9xServiceInterface agent, int placeholder)
        {
            return new ApplySolveStuckOutMessage(agent, placeholder);
        }

        public static CollectLodeOutMessage CollectLode(this IScene9xServiceInterface agent, int LodeId)
        {
            return new CollectLodeOutMessage(agent, LodeId);
        }

        public static HoldLodeOutMessage HoldLode(this IScene9xServiceInterface agent, int param)
        {
            return new HoldLodeOutMessage(agent, param);
        }
        ...
        agent.AddPublishMessageFunc(ServiceType.Scene, (evt) =>
            {
                switch (evt.Message.FuncId)
                {
                    ...
                    case 3607:
                        {
                            var data = evt.Data as __RPC_Scene_NotifyStartXpSkillGuide_ARG_int32_placeholder__;
                            agent.NotifyStartXpSkillGuide(data.Placeholder);
                        }
                        break;
                    case 3608:
                        {
                            var data = evt.Data as __RPC_Scene_NotifyStartMaYaFuBenGuide_ARG_int32_type__;
                            agent.NotifyStartMaYaFuBenGuide(data.Type);
                        }
                        break;
                    case 3610:
                        {
                            var data = evt.Data as __RPC_Scene_BroadcastSceneMonsterCount_ARG_int32_count__;
                            agent.BroadcastSceneMonsterCount(data.Count);
                        }
                        break;
                    case 3618:
                        {
                    ...
                    case 3701:
                        {
                            var data = evt.Data as __RPC_Scene_NotifyTeamMemberScene_ARG_uint64_characterId_uint64_changeCharacterId_uint64_sceneId__;
                            agent.NotifyTeamMemberScene(data.CharacterId, data.ChangeCharacterId, data.SceneId);
                        }
                        break;
                    case 3702:
                        {
                            var data = evt.Data as __RPC_Scene_ForceStopMove_ARG_PositionData_pos__;
                            agent.ForceStopMove(data.Pos);
                        }
                        break;
                    case 3703:
                        {
                            var data = evt.Data as __RPC_Scene_NotifyCommonCountdown_ARG_int32_time__;
                            agent.NotifyCommonCountdown(data.Time);
                        }
                        break;
                    case 3705:
                        {
                            var data = evt.Data as __RPC_Scene_CK_NotifyClientLevelup_ARG_uint64_objId_int32_lv_int32_exp_Dict_int_int_Data_addBuff__;
                            agent.CK_NotifyClientLevelup(data.ObjId, data.Lv, data.Exp, data.AddBuff);
                        }
                        break;
                    case 3707:
                        {
                            var data = evt.Data as __RPC_Scene_CK_NotifyCheckenSceneInfo_ARG_MsgCheckenSceneInfo_info__;
                            agent.CK_NotifyCheckenSceneInfo(data.Info);
                        }
                        break;
                    case 3708:
                        {
                            var data = evt.Data as __RPC_Scene_CK_NotifyHurt_ARG_int32_placeholder__;
                            agent.CK_NotifyHurt(data.Placeholder);
                        }
                        break;
                    case 3709:
                        {
                            var data = evt.Data as __RPC_Scene_CK_NotifyRankList_ARG_MsgCheckenRankList_rank__;
                            agent.CK_NotifyRankList(data.Rank);
                        }
                        break;
                    case 3992:
                        {
                    ...
                    case 3998:
                        {
                            var data = evt.Data as __RPC_Scene_NotifyLodeInfo_ARG_MsgSceneLode_info__;
                            agent.NotifyLodeInfo(data.Info);
                        }
                        break;
                    case 4002:
                        {
                            var data = evt.Data as __RPC_Scene_NotifyPlayEffect_ARG_int32_effectId__;
                            agent.NotifyPlayEffect(data.EffectId);
                        }
                        break;
                    default:
                        break;
    ...
    public class ChangeSceneOverOutMessage : OutMessage
    {
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Scene_ChangeSceneOver_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    {
        public MoveToOutMessage(IAgentBase sender, int sceneId, Vec2Array targetList, float offset, long time)
            : base(sender, ServiceType.Scene, 3081)
        {
            Request = new __RPC_Scene_MoveTo_ARG_int32_sceneId_Vec2Array_targetList_float_offset_int64_time__();
            Request.SceneId=sceneId;
    ...
    {
        public StopMoveOutMessage(IAgentBase sender, int sceneId, PositionData pos)
            : base(sender, ServiceType.Scene, 3084)
        {
            Request = new __RPC_Scene_StopMove_ARG_int32_sceneId_PositionData_pos__();
            Request.SceneId=sceneId;
            Request.Pos=pos;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Scene_StopMove_RET_PositionData__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    {
        public SendUseSkillRequestOutMessage(IAgentBase sender, int sceneId, CharacterUseSkillMsg msg)
            : base(sender, ServiceType.Scene, 3088)
        {
            Request = new __RPC_Scene_SendUseSkillRequest_ARG_int32_sceneId_CharacterUseSkillMsg_msg__();
            Request.SceneId=sceneId;
            Request.Msg=msg;
    ...
    public class NotifyStartXpSkillGuideOutMessage : OutMessage
    {
        public NotifyStartXpSkillGuideOutMessage(IAgentBase sender, int placeholder)
            : base(sender, ServiceType.Scene, 3607)
        {
            Request = new __RPC_Scene_NotifyStartXpSkillGuide_ARG_int32_placeholder__();
            Request.Placeholder=placeholder;

        }

        public __RPC_Scene_NotifyStartXpSkillGuide_ARG_int32_placeholder__ Request { get; private set; }
    ...
    public class NotifyStartMaYaFuBenGuideOutMessage : OutMessage
    {
        public NotifyStartMaYaFuBenGuideOutMessage(IAgentBase sender, int type)
            : base(sender, ServiceType.Scene, 3608)
        {
            Request = new __RPC_Scene_NotifyStartMaYaFuBenGuide_ARG_int32_type__();
            Request.Type=type;

        }

        public __RPC_Scene_NotifyStartMaYaFuBenGuide_ARG_int32_type__ Request { get; private set; }
    ...
    public class BroadcastSceneMonsterCountOutMessage : OutMessage
    {
        public BroadcastSceneMonsterCountOutMessage(IAgentBase sender, int count)
            : base(sender, ServiceType.Scene, 3610)
        {
            Request = new __RPC_Scene_BroadcastSceneMonsterCount_ARG_int32_count__();
            Request.Count=count;

        }

        public __RPC_Scene_BroadcastSceneMonsterCount_ARG_int32_count__ Request { get; private set; }
    ...
    public class SummonMonsterOutMessage : OutMessage
    {
        public SummonMonsterOutMessage(IAgentBase sender, int monsterId)
            : base(sender, ServiceType.Scene, 3611)
        {
            Request = new __RPC_Scene_SummonMonster_ARG_int32_monsterId__();
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Scene_SummonMonster_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class FastReachOutMessage : OutMessage
    {
        public FastReachOutMessage(IAgentBase sender, int sceneId, Vector2Int32 postion)
            : base(sender, ServiceType.Scene, 3617)
        {
    ...
    public class BroadcastSceneChatOutMessage : OutMessage
    {
        public BroadcastSceneChatOutMessage(IAgentBase sender, string content, int dictId)
            : base(sender, ServiceType.Scene, 3618)
        {
    ...
    public class SyncFuBenStoreOutMessage : OutMessage
    {
        public SyncFuBenStoreOutMessage(IAgentBase sender, StoneItems itemlst, int storeType)
            : base(sender, ServiceType.Scene, 3700)
        {
    ...
    public class NotifyTeamMemberSceneOutMessage : OutMessage
    {
        public NotifyTeamMemberSceneOutMessage(IAgentBase sender, ulong characterId, ulong changeCharacterId, ulong sceneId)
            : base(sender, ServiceType.Scene, 3701)
        {
            Request = new __RPC_Scene_NotifyTeamMemberScene_ARG_uint64_characterId_uint64_changeCharacterId_uint64_sceneId__();
            Request.CharacterId=characterId;
        ...
        public __RPC_Scene_NotifyTeamMemberScene_ARG_uint64_characterId_uint64_changeCharacterId_uint64_sceneId__ Request { get; private set; }
    ...
    public class ForceStopMoveOutMessage : OutMessage
    {
        public ForceStopMoveOutMessage(IAgentBase sender, PositionData pos)
            : base(sender, ServiceType.Scene, 3702)
        {
            Request = new __RPC_Scene_ForceStopMove_ARG_PositionData_pos__();
            Request.Pos=pos;

        }

        public __RPC_Scene_ForceStopMove_ARG_PositionData_pos__ Request { get; private set; }
    ...
    public class NotifyCommonCountdownOutMessage : OutMessage
    {
        public NotifyCommonCountdownOutMessage(IAgentBase sender, int time)
            : base(sender, ServiceType.Scene, 3703)
        {
            Request = new __RPC_Scene_NotifyCommonCountdown_ARG_int32_time__();
            Request.Time=time;

        }

        public __RPC_Scene_NotifyCommonCountdown_ARG_int32_time__ Request { get; private set; }
    ...
    public class CK_NotifyClientLevelupOutMessage : OutMessage
    {
        public CK_NotifyClientLevelupOutMessage(IAgentBase sender, ulong objId, int lv, int exp, Dict_int_int_Data addBuff)
            : base(sender, ServiceType.Scene, 3705)
        {
            Request = new __RPC_Scene_CK_NotifyClientLevelup_ARG_uint64_objId_int32_lv_int32_exp_Dict_int_int_Data_addBuff__();
            Request.ObjId=objId;
            Request.Lv=lv;
            Request.Exp=exp;
        ...
        public __RPC_Scene_CK_NotifyClientLevelup_ARG_uint64_objId_int32_lv_int32_exp_Dict_int_int_Data_addBuff__ Request { get; private set; }
    ...
    public class CK_ApplyLevelupBuffOutMessage : OutMessage
    {
        public CK_ApplyLevelupBuffOutMessage(IAgentBase sender, int buffId)
            : base(sender, ServiceType.Scene, 3706)
        {
            Request = new __RPC_Scene_CK_ApplyLevelupBuff_ARG_int32_buffId__();
    ...
    public class CK_NotifyCheckenSceneInfoOutMessage : OutMessage
    {
        public CK_NotifyCheckenSceneInfoOutMessage(IAgentBase sender, MsgCheckenSceneInfo info)
            : base(sender, ServiceType.Scene, 3707)
        {
            Request = new __RPC_Scene_CK_NotifyCheckenSceneInfo_ARG_MsgCheckenSceneInfo_info__();
            Request.Info=info;

        }

        public __RPC_Scene_CK_NotifyCheckenSceneInfo_ARG_MsgCheckenSceneInfo_info__ Request { get; private set; }
    ...
    public class CK_NotifyHurtOutMessage : OutMessage
    {
        public CK_NotifyHurtOutMessage(IAgentBase sender, int placeholder)
            : base(sender, ServiceType.Scene, 3708)
        {
            Request = new __RPC_Scene_CK_NotifyHurt_ARG_int32_placeholder__();
            Request.Placeholder=placeholder;

        }

        public __RPC_Scene_CK_NotifyHurt_ARG_int32_placeholder__ Request { get; private set; }
    ...
    public class CK_NotifyRankListOutMessage : OutMessage
    {
        public CK_NotifyRankListOutMessage(IAgentBase sender, MsgCheckenRankList rank)
            : base(sender, ServiceType.Scene, 3709)
        {
            Request = new __RPC_Scene_CK_NotifyRankList_ARG_MsgCheckenRankList_rank__();
            Request.Rank=rank;

        }

        public __RPC_Scene_CK_NotifyRankList_ARG_MsgCheckenRankList_rank__ Request { get; private set; }
    ...
    public class ApplySolveStuckOutMessage : OutMessage
    {
        public ApplySolveStuckOutMessage(IAgentBase sender, int placeholder)
            : base(sender, ServiceType.Scene, 3710)
        {
            Request = new __RPC_Scene_ApplySolveStuck_ARG_int32_placeholder__();
            Request.Placeholder=placeholder;
    ...
    public class CollectLodeOutMessage : OutMessage
    {
        public CollectLodeOutMessage(IAgentBase sender, int LodeId)
            : base(sender, ServiceType.Scene, 3995)
        {
            Request = new __RPC_Scene_CollectLode_ARG_int32_LodeId__();
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Scene_CollectLode_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class HoldLodeOutMessage : OutMessage
    {
        public HoldLodeOutMessage(IAgentBase sender, int param)
            : base(sender, ServiceType.Scene, 3997)
        {
            Request = new __RPC_Scene_HoldLode_ARG_int32_param__();
            Request.Param=param;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Scene_HoldLode_RET_string__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class NotifyLodeInfoOutMessage : OutMessage
    {
        public NotifyLodeInfoOutMessage(IAgentBase sender, MsgSceneLode info)
            : base(sender, ServiceType.Scene, 3998)
        {
            Request = new __RPC_Scene_NotifyLodeInfo_ARG_MsgSceneLode_info__();
            Request.Info=info;

        }

        public __RPC_Scene_NotifyLodeInfo_ARG_MsgSceneLode_info__ Request { get; private set; }
    ...
    public class NotifyPlayEffectOutMessage : OutMessage
    {
        public NotifyPlayEffectOutMessage(IAgentBase sender, int effectId)
            : base(sender, ServiceType.Scene, 4002)
        {
            Request = new __RPC_Scene_NotifyPlayEffect_ARG_int32_effectId__();
            Request.EffectId=effectId;

        }

        public __RPC_Scene_NotifyPlayEffect_ARG_int32_effectId__ Request { get; private set; }
