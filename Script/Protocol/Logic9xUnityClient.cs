...
namespace ClientService
{
	...
	public interface ILogic9xServiceInterface : IAgentBase
    {
        ...
        /// 主动更新图鉴组激活状态
        /// </summary>
        void ActivateBookGroup(int groupId);
        /// <summary>
        /// 主动更新邮件
        /// </summary>
        ...
        /// <summary>
        /// </summary>
        void SendMountData(MountData data);
        /// <summary>
        /// 通知记录角色结果
        /// </summary>
        void NotifySnapShotResult(int state);
        /// <summary>
        /// 增加技能点
        /// </summary>
        void AddSkillPoint(int skillId, int point);
        /// <summary>
        /// 收到角斗申请
        /// </summary>
        void ReceiveChallenge(ulong characterId, string name, string server);
    }
    public static class Logic9xServiceInterfaceExtension
    {
        ...
        public static EnchanceEquipOutMessage EnchanceEquip(this ILogic9xServiceInterface agent, int bagType, int bagIndex, int blessing, int upRate, int costGoldBlessNum)
        {
            return new EnchanceEquipOutMessage(agent, bagType, bagIndex, blessing, upRate, costGoldBlessNum);
        }
        ...
        public static ActivateBookOutMessage ActivateBook(this ILogic9xServiceInterface agent, int itemId)
        {
            return new ActivateBookOutMessage(agent, itemId);
        }
        ...
        public static PickUpMedalOutMessage PickUpMedal(this ILogic9xServiceInterface agent, int index, int flag)
        {
            return new PickUpMedalOutMessage(agent, index, flag);
        }

        public static EnchanceMedalOutMessage EnchanceMedal(this ILogic9xServiceInterface agent, int bagId, int bagIndex)
        {
            return new EnchanceMedalOutMessage(agent, bagId, bagIndex);
        }
        ...
        public static SplitMedalOutMessage SplitMedal(this ILogic9xServiceInterface agent, int bagId, int bagIndex, int flag)
        {
            return new SplitMedalOutMessage(agent, bagId, bagIndex, flag);
        }
        ...
        public static ReplaceElfSkillOutMessage ReplaceElfSkill(this ILogic9xServiceInterface agent, int elfBagIndex, int exdataIndex, int itemBagId, int itemBagIndex)
        {
            return new ReplaceElfSkillOutMessage(agent, elfBagIndex, exdataIndex, itemBagId, itemBagIndex);
        }

        public static RecycleBagItemListOutMessage RecycleBagItemList(this ILogic9xServiceInterface agent, RecycleItemList itemList)
        {
            return new RecycleBagItemListOutMessage(agent, itemList);
        }

        public static ResolveElfListOutMessage ResolveElfList(this ILogic9xServiceInterface agent, Int32Array elfIndexList)
        {
            return new ResolveElfListOutMessage(agent, elfIndexList);
        }

        public static CSEnterEraByIdOutMessage CSEnterEraById(this ILogic9xServiceInterface agent, int eraId)
        {
            return new CSEnterEraByIdOutMessage(agent, eraId);
        }

        public static EraPlayedSkillOutMessage EraPlayedSkill(this ILogic9xServiceInterface agent, int placeholder)
        {
            return new EraPlayedSkillOutMessage(agent, placeholder);
        }

        public static EraTakeAchvAwardOutMessage EraTakeAchvAward(this ILogic9xServiceInterface agent, int achvId)
        {
            return new EraTakeAchvAwardOutMessage(agent, achvId);
        }

        public static EraTakeAwardOutMessage EraTakeAward(this ILogic9xServiceInterface agent, int eraId)
        {
            return new EraTakeAwardOutMessage(agent, eraId);
        }

        public static RefreshHunterMissionOutMessage RefreshHunterMission(this ILogic9xServiceInterface agent, int placeholder)
        {
            return new RefreshHunterMissionOutMessage(agent, placeholder);
        }

        public static CSApplyOfflineExpDataOutMessage CSApplyOfflineExpData(this ILogic9xServiceInterface agent, int placeholder)
        {
            return new CSApplyOfflineExpDataOutMessage(agent, placeholder);
        }

        public static RereshTiralTimeOutMessage RereshTiralTime(this ILogic9xServiceInterface agent, int placeholder)
        {
            return new RereshTiralTimeOutMessage(agent, placeholder);
        }
        ...
        public static BuyEnergyByTypeOutMessage BuyEnergyByType(this ILogic9xServiceInterface agent, int type)
        {
            return new BuyEnergyByTypeOutMessage(agent, type);
        }

        public static ApplyKaiFuTeHuiDataOutMessage ApplyKaiFuTeHuiData(this ILogic9xServiceInterface agent, int placeholder)
        {
            return new ApplyKaiFuTeHuiDataOutMessage(agent, placeholder);
        }

        public static BuyKaiFuTeHuiItemOutMessage BuyKaiFuTeHuiItem(this ILogic9xServiceInterface agent, int tableId)
        {
            return new BuyKaiFuTeHuiItemOutMessage(agent, tableId);
        }

        public static BattleUnionDonateEquipOutMessage BattleUnionDonateEquip(this ILogic9xServiceInterface agent, int bagIndex)
        {
            return new BattleUnionDonateEquipOutMessage(agent, bagIndex);
        }

        public static BattleUnionTakeOutEquipOutMessage BattleUnionTakeOutEquip(this ILogic9xServiceInterface agent, int itemId, int bagIndex)
        {
            return new BattleUnionTakeOutEquipOutMessage(agent, itemId, bagIndex);
        }
        ...
        public static SendQuestionOutMessage SendQuestion(this ILogic9xServiceInterface agent, MailQuestion mail)
        {
            return new SendQuestionOutMessage(agent, mail);
        }

        public static SendSurveyOutMessage SendSurvey(this ILogic9xServiceInterface agent, int id, Vec2Array datas)
        {
            return new SendSurveyOutMessage(agent, id, datas);
        }
        ...
        public static TowerBuySweepTimesOutMessage TowerBuySweepTimes(this ILogic9xServiceInterface agent, int param)
        {
            return new TowerBuySweepTimesOutMessage(agent, param);
        }

        public static CheckTowerDailyInfoOutMessage CheckTowerDailyInfo(this ILogic9xServiceInterface agent, int param)
        {
            return new CheckTowerDailyInfoOutMessage(agent, param);
        }

        public static SetHandbookFightOutMessage SetHandbookFight(this ILogic9xServiceInterface agent, int id)
        {
            return new SetHandbookFightOutMessage(agent, id);
        }

        public static AskMountDataOutMessage AskMountData(this ILogic9xServiceInterface agent, uint placeholder)
        {
            return new AskMountDataOutMessage(agent, placeholder);
        }

        public static MountUpOutMessage MountUp(this ILogic9xServiceInterface agent, int param)
        {
            return new MountUpOutMessage(agent, param);
        }

        public static RideMountOutMessage RideMount(this ILogic9xServiceInterface agent, int id)
        {
            return new RideMountOutMessage(agent, id);
        }

        public static MountSkillOutMessage MountSkill(this ILogic9xServiceInterface agent, int SkillId)
        {
            return new MountSkillOutMessage(agent, SkillId);
        }

        public static MountFeedOutMessage MountFeed(this ILogic9xServiceInterface agent, int ItemId)
        {
            return new MountFeedOutMessage(agent, ItemId);
        }

        public static MountOutMessage Mount(this ILogic9xServiceInterface agent, int ItemId)
        {
            return new MountOutMessage(agent, ItemId);
        }

        public static BossHomeCostOutMessage BossHomeCost(this ILogic9xServiceInterface agent, int id)
        {
            return new BossHomeCostOutMessage(agent, id);
        }

        public static AddMountSkinOutMessage AddMountSkin(this ILogic9xServiceInterface agent, int id)
        {
            return new AddMountSkinOutMessage(agent, id);
        }

        public static ApplyFieldActivityRewardOutMessage ApplyFieldActivityReward(this ILogic9xServiceInterface agent, int id)
        {
            return new ApplyFieldActivityRewardOutMessage(agent, id);
        }

        public static ApplyFriendListDataOutMessage ApplyFriendListData(this ILogic9xServiceInterface agent, int id)
        {
            return new ApplyFriendListDataOutMessage(agent, id);
        }

        public static UseShiZhuangOutMessage UseShiZhuang(this ILogic9xServiceInterface agent, int bagId, int bagItemIndex, int part)
        {
            return new UseShiZhuangOutMessage(agent, bagId, bagItemIndex, part);
        }

        public static ClickMayaTipOutMessage ClickMayaTip(this ILogic9xServiceInterface agent, int id)
        {
            return new ClickMayaTipOutMessage(agent, id);
        }

        public static ChangeEquipStateOutMessage ChangeEquipState(this ILogic9xServiceInterface agent, Int32Array parts, bool state)
        {
            return new ChangeEquipStateOutMessage(agent, parts, state);
        }

        public static RefreshFashionInfoOutMessage RefreshFashionInfo(this ILogic9xServiceInterface agent, int placeholder)
        {
            return new RefreshFashionInfoOutMessage(agent, placeholder);
        }

        public static ApplySuperVIPOutMessage ApplySuperVIP(this ILogic9xServiceInterface agent, int id)
        {
            return new ApplySuperVIPOutMessage(agent, id);
        }

        public static WorshipMonumentOutMessage WorshipMonument(this ILogic9xServiceInterface agent, int MonumentId)
        {
            return new WorshipMonumentOutMessage(agent, MonumentId);
        }

        public static SaveSuperExcellentEquipOutMessage SaveSuperExcellentEquip(this ILogic9xServiceInterface agent, int bagType, int bagIndex, int ok)
        {
            return new SaveSuperExcellentEquipOutMessage(agent, bagType, bagIndex, ok);
        }

        public static ModifyPlayerNameOutMessage ModifyPlayerName(this ILogic9xServiceInterface agent, string modifyName)
        {
            return new ModifyPlayerNameOutMessage(agent, modifyName);
        }

        public static InviteChallengeOutMessage InviteChallenge(this ILogic9xServiceInterface agent, ulong characterId)
        {
            return new InviteChallengeOutMessage(agent, characterId);
        }

        public static AcceptChallengeOutMessage AcceptChallenge(this ILogic9xServiceInterface agent, ulong characterId, bool accept)
        {
            return new AcceptChallengeOutMessage(agent, characterId, accept);
        }
        ...
        agent.AddPublishMessageFunc(ServiceType.Logic, (evt) =>
            {
                switch (evt.Message.FuncId)
                {
                    ...
                    case 1319:
                        {
                            var data = evt.Data as __RPC_Logic_ActivateBookGroup_ARG_int32_groupId__;
                            agent.ActivateBookGroup(data.GroupId);
                        }
                        break;
                    case 1116:
                        {
                    ...
                    case 1327:
                        {
                            var data = evt.Data as __RPC_Logic_SendMountData_ARG_MountData_data__;
                            agent.SendMountData(data.Data);
                        }
                        break;
                    case 1328:
                        {
                            var data = evt.Data as __RPC_Logic_NotifySnapShotResult_ARG_int32_state__;
                            agent.NotifySnapShotResult(data.State);
                        }
                        break;
                    case 1331:
                        {
                            var data = evt.Data as __RPC_Logic_AddSkillPoint_ARG_int32_skillId_int32_point__;
                            agent.AddSkillPoint(data.SkillId, data.Point);
                        }
                        break;
                    case 1353:
                        {
                            var data = evt.Data as __RPC_Logic_ReceiveChallenge_ARG_uint64_characterId_string_name_string_server__;
                            agent.ReceiveChallenge(data.CharacterId, data.Name, data.Server);
                        }
                        break;
                    default:
                        break;
    ...
    {
        public EnchanceEquipOutMessage(IAgentBase sender, int bagType, int bagIndex, int blessing, int upRate, int costGoldBlessNum)
            : base(sender, ServiceType.Logic, 1072)
        {
            Request = new __RPC_Logic_EnchanceEquip_ARG_int32_bagType_int32_bagIndex_int32_blessing_int32_upRate_int32_costGoldBlessNum__();
            Request.BagType=bagType;
            Request.BagIndex=bagIndex;
            Request.Blessing=blessing;
            Request.UpRate=upRate;
            Request.CostGoldBlessNum=costGoldBlessNum;
    ...
    {
        public ActivateBookOutMessage(IAgentBase sender, int itemId)
            : base(sender, ServiceType.Logic, 1107)
        {
            Request = new __RPC_Logic_ActivateBook_ARG_int32_itemId__();
            Request.ItemId=itemId;
    ...
    public class ActivateBookGroupOutMessage : OutMessage
    {
        public ActivateBookGroupOutMessage(IAgentBase sender, int groupId)
            : base(sender, ServiceType.Logic, 1319)
        {
            Request = new __RPC_Logic_ActivateBookGroup_ARG_int32_groupId__();
            Request.GroupId=groupId;

        }

        public __RPC_Logic_ActivateBookGroup_ARG_int32_groupId__ Request { get; private set; }
    ...
    {
        public PickUpMedalOutMessage(IAgentBase sender, int index, int flag)
            : base(sender, ServiceType.Logic, 1140)
        {
            Request = new __RPC_Logic_PickUpMedal_ARG_int32_index_int32_flag__();
            Request.Index=index;
            Request.Flag=flag;
    ...
    {
        public EnchanceMedalOutMessage(IAgentBase sender, int bagId, int bagIndex)
            : base(sender, ServiceType.Logic, 1141)
        {
            Request = new __RPC_Logic_EnchanceMedal_ARG_int32_bagId_int32_bagIndex__();
            Request.BagId=bagId;
            Request.BagIndex=bagIndex;
    ...
    public class SplitMedalOutMessage : OutMessage
    {
        public SplitMedalOutMessage(IAgentBase sender, int bagId, int bagIndex, int flag)
            : base(sender, ServiceType.Logic, 1317)
        {
            Request = new __RPC_Logic_SplitMedal_ARG_int32_bagId_int32_bagIndex_int32_flag__();
            Request.BagId=bagId;
            Request.BagIndex=bagIndex;
            Request.Flag=flag;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_SplitMedal_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class ReplaceElfSkillOutMessage : OutMessage
    {
        public ReplaceElfSkillOutMessage(IAgentBase sender, int elfBagIndex, int exdataIndex, int itemBagId, int itemBagIndex)
            : base(sender, ServiceType.Logic, 1250)
        {
            Request = new __RPC_Logic_ReplaceElfSkill_ARG_int32_elfBagIndex_int32_exdataIndex_int32_itemBagId_int32_itemBagIndex__();
            Request.ElfBagIndex=elfBagIndex;
            Request.ExdataIndex=exdataIndex;
            Request.ItemBagId=itemBagId;
            Request.ItemBagIndex=itemBagIndex;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_ReplaceElfSkill_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class RecycleBagItemListOutMessage : OutMessage
    {
        public RecycleBagItemListOutMessage(IAgentBase sender, RecycleItemList itemList)
            : base(sender, ServiceType.Logic, 1252)
        {
            Request = new __RPC_Logic_RecycleBagItemList_ARG_RecycleItemList_itemList__();
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_RecycleBagItemList_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class ResolveElfListOutMessage : OutMessage
    {
        public ResolveElfListOutMessage(IAgentBase sender, Int32Array elfIndexList)
            : base(sender, ServiceType.Logic, 1253)
        {
            Request = new __RPC_Logic_ResolveElfList_ARG_Int32Array_elfIndexList__();
            Request.ElfIndexList=elfIndexList;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_ResolveElfList_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class CSEnterEraByIdOutMessage : OutMessage
    {
        public CSEnterEraByIdOutMessage(IAgentBase sender, int eraId)
            : base(sender, ServiceType.Logic, 1260)
        {
            Request = new __RPC_Logic_CSEnterEraById_ARG_int32_eraId__();
            Request.EraId=eraId;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_CSEnterEraById_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class EraPlayedSkillOutMessage : OutMessage
    {
        public EraPlayedSkillOutMessage(IAgentBase sender, int placeholder)
            : base(sender, ServiceType.Logic, 1261)
        {
            Request = new __RPC_Logic_EraPlayedSkill_ARG_int32_placeholder__();
            Request.Placeholder=placeholder;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_EraPlayedSkill_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class EraTakeAchvAwardOutMessage : OutMessage
    {
        public EraTakeAchvAwardOutMessage(IAgentBase sender, int achvId)
            : base(sender, ServiceType.Logic, 1262)
        {
            Request = new __RPC_Logic_EraTakeAchvAward_ARG_int32_achvId__();
            Request.AchvId=achvId;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_EraTakeAchvAward_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class EraTakeAwardOutMessage : OutMessage
    {
        public EraTakeAwardOutMessage(IAgentBase sender, int eraId)
            : base(sender, ServiceType.Logic, 1263)
        {
            Request = new __RPC_Logic_EraTakeAward_ARG_int32_eraId__();
            Request.EraId=eraId;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_EraTakeAward_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class RefreshHunterMissionOutMessage : OutMessage
    {
        public RefreshHunterMissionOutMessage(IAgentBase sender, int placeholder)
            : base(sender, ServiceType.Logic, 1264)
        {
            Request = new __RPC_Logic_RefreshHunterMission_ARG_int32_placeholder__();
            Request.Placeholder=placeholder;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_RefreshHunterMission_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class CSApplyOfflineExpDataOutMessage : OutMessage
    {
        public CSApplyOfflineExpDataOutMessage(IAgentBase sender, int placeholder)
            : base(sender, ServiceType.Logic, 1270)
        {
            Request = new __RPC_Logic_CSApplyOfflineExpData_ARG_int32_placeholder__();
            Request.Placeholder=placeholder;
        ...
        public __RPC_Logic_CSApplyOfflineExpData_ARG_int32_placeholder__ Request { get; private set; }
            ...
            public OfflineExpData Response { get { return mResponse.ReturnValue; } }
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_CSApplyOfflineExpData_RET_OfflineExpData__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class RereshTiralTimeOutMessage : OutMessage
    {
        public RereshTiralTimeOutMessage(IAgentBase sender, int placeholder)
            : base(sender, ServiceType.Logic, 1271)
        {
            Request = new __RPC_Logic_RereshTiralTime_ARG_int32_placeholder__();
            Request.Placeholder=placeholder;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_RereshTiralTime_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class BuyEnergyByTypeOutMessage : OutMessage
    {
        public BuyEnergyByTypeOutMessage(IAgentBase sender, int type)
            : base(sender, ServiceType.Logic, 1602)
        {
            Request = new __RPC_Logic_BuyEnergyByType_ARG_int32_type__();
            Request.Type=type;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_BuyEnergyByType_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class ApplyKaiFuTeHuiDataOutMessage : OutMessage
    {
        public ApplyKaiFuTeHuiDataOutMessage(IAgentBase sender, int placeholder)
            : base(sender, ServiceType.Logic, 1606)
        {
            Request = new __RPC_Logic_ApplyKaiFuTeHuiData_ARG_int32_placeholder__();
            Request.Placeholder=placeholder;
        ...
        public __RPC_Logic_ApplyKaiFuTeHuiData_ARG_int32_placeholder__ Request { get; private set; }
            ...
            public KaiFuTeHuiData Response { get { return mResponse.ReturnValue; } }
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_ApplyKaiFuTeHuiData_RET_KaiFuTeHuiData__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class BuyKaiFuTeHuiItemOutMessage : OutMessage
    {
        public BuyKaiFuTeHuiItemOutMessage(IAgentBase sender, int tableId)
            : base(sender, ServiceType.Logic, 1607)
        {
            Request = new __RPC_Logic_BuyKaiFuTeHuiItem_ARG_int32_tableId__();
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_BuyKaiFuTeHuiItem_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class BattleUnionDonateEquipOutMessage : OutMessage
    {
        public BattleUnionDonateEquipOutMessage(IAgentBase sender, int bagIndex)
            : base(sender, ServiceType.Logic, 1608)
        {
            Request = new __RPC_Logic_BattleUnionDonateEquip_ARG_int32_bagIndex__();
            Request.BagIndex=bagIndex;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_BattleUnionDonateEquip_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class BattleUnionTakeOutEquipOutMessage : OutMessage
    {
        public BattleUnionTakeOutEquipOutMessage(IAgentBase sender, int itemId, int bagIndex)
            : base(sender, ServiceType.Logic, 1609)
        {
            Request = new __RPC_Logic_BattleUnionTakeOutEquip_ARG_int32_itemId_int32_bagIndex__();
            Request.ItemId=itemId;
            Request.BagIndex=bagIndex;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_BattleUnionTakeOutEquip_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    {
        public SendQuestionOutMessage(IAgentBase sender, MailQuestion mail)
            : base(sender, ServiceType.Logic, 1604)
        {
            Request = new __RPC_Logic_SendQuestion_ARG_MailQuestion_mail__();
            Request.Mail=mail;
    ...
    public class SendSurveyOutMessage : OutMessage
    {
        public SendSurveyOutMessage(IAgentBase sender, int id, Vec2Array datas)
            : base(sender, ServiceType.Logic, 1330)
        {
            Request = new __RPC_Logic_SendSurvey_ARG_int32_id_Vec2Array_datas__();
            Request.Id=id;
            Request.Datas=datas;
    ...
    public class TowerBuySweepTimesOutMessage : OutMessage
    {
        public TowerBuySweepTimesOutMessage(IAgentBase sender, int param)
            : base(sender, ServiceType.Logic, 1315)
        {
            Request = new __RPC_Logic_TowerBuySweepTimes_ARG_int32_param__();
            Request.Param=param;
    ...
    public class CheckTowerDailyInfoOutMessage : OutMessage
    {
        public CheckTowerDailyInfoOutMessage(IAgentBase sender, int param)
            : base(sender, ServiceType.Logic, 1316)
        {
            Request = new __RPC_Logic_CheckTowerDailyInfo_ARG_int32_param__();
            Request.Param=param;
    ...
    public class SetHandbookFightOutMessage : OutMessage
    {
        public SetHandbookFightOutMessage(IAgentBase sender, int id)
            : base(sender, ServiceType.Logic, 1318)
        {
            Request = new __RPC_Logic_SetHandbookFight_ARG_int32_id__();
            Request.Id=id;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_SetHandbookFight_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class AskMountDataOutMessage : OutMessage
    {
        public AskMountDataOutMessage(IAgentBase sender, uint placeholder)
            : base(sender, ServiceType.Logic, 1320)
        {
            Request = new __RPC_Logic_AskMountData_ARG_uint32_placeholder__();
            Request.Placeholder=placeholder;
        ...
        public __RPC_Logic_AskMountData_ARG_uint32_placeholder__ Request { get; private set; }
            ...
            public MountData Response { get { return mResponse.ReturnValue; } }
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_AskMountData_RET_MountData__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class MountUpOutMessage : OutMessage
    {
        public MountUpOutMessage(IAgentBase sender, int param)
            : base(sender, ServiceType.Logic, 1321)
        {
            Request = new __RPC_Logic_MountUp_ARG_int32_param__();
            Request.Param=param;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_MountUp_RET_Int32Array__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class RideMountOutMessage : OutMessage
    {
        public RideMountOutMessage(IAgentBase sender, int id)
            : base(sender, ServiceType.Logic, 1322)
        {
            Request = new __RPC_Logic_RideMount_ARG_int32_id__();
            Request.Id=id;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_RideMount_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class MountSkillOutMessage : OutMessage
    {
        public MountSkillOutMessage(IAgentBase sender, int SkillId)
            : base(sender, ServiceType.Logic, 1323)
        {
            Request = new __RPC_Logic_MountSkill_ARG_int32_SkillId__();
            Request.SkillId=SkillId;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_MountSkill_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class MountFeedOutMessage : OutMessage
    {
        public MountFeedOutMessage(IAgentBase sender, int ItemId)
            : base(sender, ServiceType.Logic, 1324)
        {
            Request = new __RPC_Logic_MountFeed_ARG_int32_ItemId__();
            Request.ItemId=ItemId;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_MountFeed_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class MountOutMessage : OutMessage
    {
        public MountOutMessage(IAgentBase sender, int ItemId)
            : base(sender, ServiceType.Logic, 1326)
        {
            Request = new __RPC_Logic_Mount_ARG_int32_ItemId__();
            Request.ItemId=ItemId;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_Mount_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class SendMountDataOutMessage : OutMessage
    {
        public SendMountDataOutMessage(IAgentBase sender, MountData data)
            : base(sender, ServiceType.Logic, 1327)
        {
            Request = new __RPC_Logic_SendMountData_ARG_MountData_data__();
            Request.Data=data;

        }

        public __RPC_Logic_SendMountData_ARG_MountData_data__ Request { get; private set; }
    ...
    public class NotifySnapShotResultOutMessage : OutMessage
    {
        public NotifySnapShotResultOutMessage(IAgentBase sender, int state)
            : base(sender, ServiceType.Logic, 1328)
        {
            Request = new __RPC_Logic_NotifySnapShotResult_ARG_int32_state__();
            Request.State=state;

        }

        public __RPC_Logic_NotifySnapShotResult_ARG_int32_state__ Request { get; private set; }
    ...
    public class AddSkillPointOutMessage : OutMessage
    {
        public AddSkillPointOutMessage(IAgentBase sender, int skillId, int point)
            : base(sender, ServiceType.Logic, 1331)
        {
            Request = new __RPC_Logic_AddSkillPoint_ARG_int32_skillId_int32_point__();
            Request.SkillId=skillId;
            Request.Point=point;

        }

        public __RPC_Logic_AddSkillPoint_ARG_int32_skillId_int32_point__ Request { get; private set; }
    ...
    public class BossHomeCostOutMessage : OutMessage
    {
        public BossHomeCostOutMessage(IAgentBase sender, int id)
            : base(sender, ServiceType.Logic, 1332)
        {
            Request = new __RPC_Logic_BossHomeCost_ARG_int32_id__();
            Request.Id=id;
    ...
    public class AddMountSkinOutMessage : OutMessage
    {
        public AddMountSkinOutMessage(IAgentBase sender, int id)
            : base(sender, ServiceType.Logic, 1336)
        {
            Request = new __RPC_Logic_AddMountSkin_ARG_int32_id__();
            Request.Id=id;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_AddMountSkin_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class ApplyFieldActivityRewardOutMessage : OutMessage
    {
        public ApplyFieldActivityRewardOutMessage(IAgentBase sender, int id)
            : base(sender, ServiceType.Logic, 1337)
        {
            Request = new __RPC_Logic_ApplyFieldActivityReward_ARG_int32_id__();
            Request.Id=id;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_ApplyFieldActivityReward_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class ApplyFriendListDataOutMessage : OutMessage
    {
        public ApplyFriendListDataOutMessage(IAgentBase sender, int id)
            : base(sender, ServiceType.Logic, 1338)
        {
            Request = new __RPC_Logic_ApplyFriendListData_ARG_int32_id__();
            Request.Id=id;
        ...
        public __RPC_Logic_ApplyFriendListData_ARG_int32_id__ Request { get; private set; }
            ...
            public MsgFriendList Response { get { return mResponse.ReturnValue; } }
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_ApplyFriendListData_RET_MsgFriendList__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class UseShiZhuangOutMessage : OutMessage
    {
        public UseShiZhuangOutMessage(IAgentBase sender, int bagId, int bagItemIndex, int part)
            : base(sender, ServiceType.Logic, 1340)
        {
            Request = new __RPC_Logic_UseShiZhuang_ARG_int32_bagId_int32_bagItemIndex_int32_part__();
            Request.BagId=bagId;
            Request.BagItemIndex=bagItemIndex;
            Request.Part=part;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_UseShiZhuang_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class ClickMayaTipOutMessage : OutMessage
    {
        public ClickMayaTipOutMessage(IAgentBase sender, int id)
            : base(sender, ServiceType.Logic, 1341)
        {
            Request = new __RPC_Logic_ClickMayaTip_ARG_int32_id__();
            Request.Id=id;
    ...
    public class ChangeEquipStateOutMessage : OutMessage
    {
        public ChangeEquipStateOutMessage(IAgentBase sender, Int32Array parts, bool state)
            : base(sender, ServiceType.Logic, 1343)
        {
            Request = new __RPC_Logic_ChangeEquipState_ARG_Int32Array_parts_bool_state__();
            Request.Parts=parts;
            Request.State=state;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_ChangeEquipState_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class RefreshFashionInfoOutMessage : OutMessage
    {
        public RefreshFashionInfoOutMessage(IAgentBase sender, int placeholder)
            : base(sender, ServiceType.Logic, 1345)
        {
            Request = new __RPC_Logic_RefreshFashionInfo_ARG_int32_placeholder__();
            Request.Placeholder=placeholder;
    ...
    public class ApplySuperVIPOutMessage : OutMessage
    {
        public ApplySuperVIPOutMessage(IAgentBase sender, int id)
            : base(sender, ServiceType.Logic, 1348)
        {
            Request = new __RPC_Logic_ApplySuperVIP_ARG_int32_id__();
            Request.Id=id;
        ...
        public __RPC_Logic_ApplySuperVIP_ARG_int32_id__ Request { get; private set; }
            ...
            public SuperVIPData Response { get { return mResponse.ReturnValue; } }
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_ApplySuperVIP_RET_SuperVIPData__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class WorshipMonumentOutMessage : OutMessage
    {
        public WorshipMonumentOutMessage(IAgentBase sender, int MonumentId)
            : base(sender, ServiceType.Logic, 1349)
        {
            Request = new __RPC_Logic_WorshipMonument_ARG_int32_MonumentId__();
            Request.MonumentId=MonumentId;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_WorshipMonument_RET_Dict_int_int_Data__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class SaveSuperExcellentEquipOutMessage : OutMessage
    {
        public SaveSuperExcellentEquipOutMessage(IAgentBase sender, int bagType, int bagIndex, int ok)
            : base(sender, ServiceType.Logic, 1350)
        {
            Request = new __RPC_Logic_SaveSuperExcellentEquip_ARG_int32_bagType_int32_bagIndex_int32_ok__();
            Request.BagType=bagType;
            Request.BagIndex=bagIndex;
            Request.Ok=ok;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_SaveSuperExcellentEquip_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class ModifyPlayerNameOutMessage : OutMessage
    {
        public ModifyPlayerNameOutMessage(IAgentBase sender, string modifyName)
            : base(sender, ServiceType.Logic, 1351)
        {
            Request = new __RPC_Logic_ModifyPlayerName_ARG_string_modifyName__();
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_ModifyPlayerName_RET_string__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class InviteChallengeOutMessage : OutMessage
    {
        public InviteChallengeOutMessage(IAgentBase sender, ulong characterId)
            : base(sender, ServiceType.Logic, 1352)
        {
            Request = new __RPC_Logic_InviteChallenge_ARG_uint64_characterId__();
            Request.CharacterId=characterId;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_InviteChallenge_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class ReceiveChallengeOutMessage : OutMessage
    {
        public ReceiveChallengeOutMessage(IAgentBase sender, ulong characterId, string name, string server)
            : base(sender, ServiceType.Logic, 1353)
        {
            Request = new __RPC_Logic_ReceiveChallenge_ARG_uint64_characterId_string_name_string_server__();
            Request.CharacterId=characterId;
            Request.Name=name;
        ...
        public __RPC_Logic_ReceiveChallenge_ARG_uint64_characterId_string_name_string_server__ Request { get; private set; }
    ...
    public class AcceptChallengeOutMessage : OutMessage
    {
        public AcceptChallengeOutMessage(IAgentBase sender, ulong characterId, bool accept)
            : base(sender, ServiceType.Logic, 1354)
        {
            Request = new __RPC_Logic_AcceptChallenge_ARG_uint64_characterId_bool_accept__();
            Request.CharacterId=characterId;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Logic_AcceptChallenge_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
