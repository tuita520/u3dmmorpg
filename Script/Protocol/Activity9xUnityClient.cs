...
namespace ClientService
{
	...
	public interface IActivity9xServiceInterface : IAgentBase
    {
        ...
        /// <summary>
        /// </summary>
        void NotifyMieShiActivityInfo(CommonActivityData msg);
        /// <summary>
        /// 通知客户端某个炮台数据更新
    ...
    public static class Activity9xServiceInterfaceExtension
    {
        ...
        public static ApplyAcientBattleOutMessage ApplyAcientBattle(this IActivity9xServiceInterface agent, int serverId)
        {
            return new ApplyAcientBattleOutMessage(agent, serverId);
        }
    ...
    public class ApplyMieshiHeroLogDataOutMessage : OutMessage
    {
        public ApplyMieshiHeroLogDataOutMessage(IAgentBase sender, int serverId)
            : base(sender, ServiceType.Activity, 4099)
        {
            Request = new __RPC_Activity_ApplyMieshiHeroLogData_ARG_int32_serverId__();
            Request.ServerId=serverId;
        ...
        public __RPC_Activity_ApplyMieshiHeroLogData_ARG_int32_serverId__ Request { get; private set; }
            ...
            public MieshiHeroLogList Response { get { return mResponse.ReturnValue; } }
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Activity_ApplyMieshiHeroLogData_RET_MieshiHeroLogList__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class NotifyMieShiActivityInfoOutMessage : OutMessage
    {
        public NotifyMieShiActivityInfoOutMessage(IAgentBase sender, CommonActivityData msg)
            : base(sender, ServiceType.Activity, 4115)
        {
            Request = new __RPC_Activity_NotifyMieShiActivityInfo_ARG_CommonActivityData_msg__();
            Request.Msg=msg;

        }

        public __RPC_Activity_NotifyMieShiActivityInfo_ARG_CommonActivityData_msg__ Request { get; private set; }
    ...
    public class ApplyAcientBattleOutMessage : OutMessage
    {
        public ApplyAcientBattleOutMessage(IAgentBase sender, int serverId)
            : base(sender, ServiceType.Activity, 4118)
        {
            Request = new __RPC_Activity_ApplyAcientBattle_ARG_int32_serverId__();
            Request.ServerId=serverId;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Activity_ApplyAcientBattle_RET_Dict_int_int_Data__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class ApplyBossHomeOutMessage : OutMessage
    {
        public ApplyBossHomeOutMessage(IAgentBase sender, int serverId)
            : base(sender, ServiceType.Activity, 4025)
        {
            Request = new __RPC_Activity_ApplyBossHome_ARG_int32_serverId__();
            Request.ServerId=serverId;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Activity_ApplyBossHome_RET_Dict_int_int_Data__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    public class ApplyChickenRankDataOutMessage : OutMessage
    {
        public ApplyChickenRankDataOutMessage(IAgentBase sender, ulong characterId)
            : base(sender, ServiceType.Activity, 4506)
        {
            Request = new __RPC_Activity_ApplyChickenRankData_ARG_uint64_characterId__();
        ...
        public __RPC_Activity_ApplyChickenRankData_ARG_uint64_characterId__ Request { get; private set; }
            ...
            public ChickenRankData Response { get { return mResponse.ReturnValue; } }
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Activity_ApplyChickenRankData_RET_ChickenRankData__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
