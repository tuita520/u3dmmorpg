...
namespace ClientService
{
    ...
    public class GetAllCharactersLoginInfoOutMessage : OutMessage
    {
        public GetAllCharactersLoginInfoOutMessage(IAgentBase sender, int serverId)
            : base(sender, ServiceType.Login, 2039)
        {
            Request = new __RPC_Login_GetAllCharactersLoginInfo_ARG_int32_serverId__();
            Request.ServerId=serverId;
        ...
        public __RPC_Login_GetAllCharactersLoginInfo_ARG_int32_serverId__ Request { get; private set; }
            ...
            public AllCharacterLoginInfo Response { get { return mResponse.ReturnValue; } }
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Login_GetAllCharactersLoginInfo_RET_AllCharacterLoginInfo__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
    ...
    {
        public GetAnchorIsInRoomOutMessage(IAgentBase sender, ulong CharacterId)
            : base(sender, ServiceType.Login, 2040)
        {
            Request = new __RPC_Login_GetAnchorIsInRoom_ARG_uint64_CharacterId__();
            Request.CharacterId=CharacterId;
        ...
        public override void SetResponse(uint error, byte[] data)
        {
            ...
            {
                var ms = new MemoryStream(data, false);
                mResponse = Serializer.Deserialize<__RPC_Login_GetAnchorIsInRoom_RET_int32__>(ms);
            }
            State = MessageState.Reply;
            ErrorCode = (int) error;
        }
