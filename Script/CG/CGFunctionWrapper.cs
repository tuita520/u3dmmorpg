...
return 1;
}public static object cgChangeToDay(Expression[] args)
{
if (args.Length < 0)
{
Logger.Error("cgChangeToDay() args<[0]");
return 0;
}
PlayCG.Instance.cgChangeToDay(
);
return 1;
}public static object cgChangeToNight(Expression[] args)
{
if (args.Length < 0)
{
Logger.Error("cgChangeToNight() args<[0]");
return 0;
}
PlayCG.Instance.cgChangeToNight(
);
return 1;
}
}
