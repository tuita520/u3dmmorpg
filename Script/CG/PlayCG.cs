...
public class PlayCG : Singleton<PlayCG>
{
    ...
    private bool isPlayCG = false;
    public bool IsPlayCG
    {
        get { return isPlayCG; }
        set { isPlayCG = value; }
    }

    private bool isStopCG = false;

    public bool IsStopCG
    {
        get { return isStopCG; }
        set { isStopCG = value; }
    }
    ...
    public void cgAttach(string name1, string point1, string name2, string point2)
    {
	    ...
	    var nav = go1.GetComponent<NavMeshAgent>();
		if (null!=nav)
	    {
		    nav.enabled = false;
	    }
    ...
    public void cgCloneMyPlayer(int id)
    {
        ...
        var obj = Actor.Create(dataId, equip, actor =>
        {
            ...
            ProcessCommand();
        }, LayerMask.NameToLayer(GAMELAYER.CGMainPlayer), false, false);
    }
...
// 		}
	...
	*/
    ...
    public void cgChangeToDay()
    {
        var tmp = GameLogic.Instance.GetComponentInChildren<DayNightSwitcher>();
        if (tmp)
        {
            tmp.SetToDay();
        }
    ...
    public void RegisterCallFunc()
    {
        ...
        mExecutor.RegisterFunction("cgChangeToDay", CGFunctionWrapper.cgChangeToDay);
        mExecutor.RegisterFunction("cgChangeToNight", CGFunctionWrapper.cgChangeToNight);
    ...
    public void Reset()
    {
        ...
        if (null != mLogic)
        {
            ...
            {               
                ...
                isStopCG = true;
                EventDispatcher.Instance.DispatchEvent(new CGDestoryEvent());
            }
        }
        mLogic = null;
    }
    ...
    public void Stop(bool isSkip=false)
    {
	    try
	    {
			...
			if (null != GameLogic.Instance)
			{
				...
				EventDispatcher.Instance.DispatchEvent(new PlayCgEvent(1));
