...
namespace GameUI
{
    public class WishingFrame : MonoBehaviour
    {
        ...
        private void OnDestroy()
        {
            ...
            EventDispatcher.Instance.RemoveEventListener(PlayGoldOrExpEffectEvent.EVENT_TYPE, OnPlayGoldOrExpEffectEvent);
	...
	try
	{
            ...
            if (mFlyUIEvent != null)
            {
                ExpFlyAnimation(mFlyUIEvent);
            }
            if (null != GoldEffect && null != ExpEffect)
            {
	...
	try
	{
            ...
            EventDispatcher.Instance.AddEventListener(PlayGoldOrExpEffectEvent.EVENT_TYPE, OnPlayGoldOrExpEffectEvent);
	...
	catch (Exception ex)
	{
        ...
        {
            var e = new UIEvent_WishingOperation(22);
        ...
        public void OnClickExchangeBtn()
        {
            //切换到祈福界面关闭愿望包裹
            BtnWishingBagBack();
            var e = new UIEvent_WishingOperation(23);
            EventDispatcher.Instance.DispatchEvent(e);
        }
        ...
        public void OnFormatTimer(UILabel lable)
        {
            ...
            if (str == string.Empty)
            {
                EventDispatcher.Instance.DispatchEvent(new UIEvent_WishShowFreeDrawEvent());
            }
        }
        ...
        private IEnumerator InitPreBagCellfab()
        {
            ...
            {
                var BagCell = Instantiate(res) as GameObject;
        ...
        #endregion
        private void OnPlayGoldOrExpEffectEvent(IEvent ievent)
        {
            var e = ievent as PlayGoldOrExpEffectEvent;
            switch (e.Type)
            {
                case 0:
                    {
