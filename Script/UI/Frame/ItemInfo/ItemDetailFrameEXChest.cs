...
namespace GameUI
{
    public class ItemDetailFrameEXChest : MonoBehaviour, IChainRoot, IChainListener
    {
        ...
        public BindDataRoot GetInfoBindRoot;
  ...
  //  public GameObject SellMessage;
    ...
    public List<GameObject> ShowContent;
        ...
        private void OnEnable()
        {
            ...
            // SellMessage.SetActive(false);
            UseMessage.SetActive(false);
            var controllerBase = UIManager.Instance.GetController(UIConfig.ChestInfoUI);
            BindRoot.SetBindDataSource(controllerBase.GetDataModel(""));

            ClientDataModel.ItemInfoDataModel iidm =
                controllerBase.GetDataModel("ItemInfoDataModel") as ClientDataModel.ItemInfoDataModel;
            // if(iidm.GetPathList() != null && )
            BindRoot.SetBindDataSource(iidm);
        ...
        private void PutInCenter()
        {
            ...
            ButtonList.transform.localPosition = new Vector3(315, -center + 70, 0);
        }
