...
namespace GameUI
{
	public class IllustrationCell : MonoBehaviour
	{
	    ...
	    private IEnumerator DoCompose()
	    {
	        ...
	        var e = new UIEvent_HandBookFrame_ComposeBookPiece();
	    ...
	    {
            var e = new UIEvent_HandBookFrame_OnBookClickGet();
            EventDispatcher.Instance.DispatchEvent(e);
	    }
	    public void OnCardClick()
	    {
	        if (EffectRoot == null)
	        {
                var e = new UIEvent_HandBookFrame_OnBookItemClick(ItemLogic.Item as HandBookItemDataModel);
                EventDispatcher.Instance.DispatchEvent(e);
	        }
	        else
	        {
