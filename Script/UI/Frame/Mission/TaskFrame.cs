...
namespace GameUI
{
	public class TaskFrame : MonoBehaviour
	{
	    ...
	    public UIMissionAutoAccept AutoAcceptScrpt;
	...
	try
	{
            ...
            EventDispatcher.Instance.AddEventListener(MissionAutoAcceptEvent.EVENT_TYPE, OnAutoAcceptEvent);
	...
	catch (Exception ex)
	{
        ...
        private void OnAutoAcceptEvent(IEvent ievent)
	    {
            var e = ievent as MissionAutoAcceptEvent;
            if (e == null || e.IsAccept == null)
            {
                return;
            }
            if (AutoAcceptScrpt == null)
            {
                return;
            }
            ...
            //AutoAcceptScrpt.StartAccept(e.IsAccept);
	    }

	    public void OnOKClick()
	    {
	        MissionManager.Instance.OperateCurrentMission();
            AutoAcceptScrpt.OkClick();
	    }
	    ...
	    public void OnTextOneByOneOver()
	    {
            ...
            AutoAcceptScrpt.StartAccept(isAccept);
	    }
