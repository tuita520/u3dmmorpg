...
namespace GameUI
{
	public class BattleUnionFrame : MonoBehaviour
	{
        ...
        public GameObject Gold1Effect;
        public GameObject Gold2Effect;
        public GameObject Gold3Effect;

        public GameObject DepotDonationTip;
        public GameObject DepotClearUpTip;
	...
	try
	{
	        ...
	        if (removeBind)
	        {
                ...
                EventDispatcher.Instance.AddEventListener(PlayBattleUnionEffect.EVENT_TYPE, OnPlayBattleUnionEffectEvent);
                ...
                Binding.SetBindDataSource(controllerBase.GetDataModel("Depot"));
	...
	catch (Exception ex)
	{
	    ...
	    private void RemoveBindingEvent()
	    {
            ...
            EventDispatcher.Instance.RemoveEventListener(PlayBattleUnionEffect.EVENT_TYPE,OnPlayBattleUnionEffectEvent);
	    }
	...
	catch (Exception ex)
	{
        ...
        private void OnPlayBattleUnionEffectEvent(IEvent ievent)
        {
            var e = ievent as PlayBattleUnionEffect;
            switch (e.EffectNumber)
            {
                case 0:
                    {
                        if (null == Gold1Effect)
                        ...
                        Gold1Effect.SetActive(false);
                        Gold1Effect.SetActive(true);
                    }
                    break;
                case 1:
                    {
                        ...
                        Gold2Effect.SetActive(false);
                        Gold2Effect.SetActive(true);
                    }
                    break;
                case 2:
                    {
                        ...
                        Gold3Effect.SetActive(false);
                        Gold3Effect.SetActive(true);
                    }
                    break;
            }
        }
	...
	catch (Exception ex)
	{
        ...
        public void AllPass()
        {
            var e = new BattleUnionOperationEvent(0);
            EventDispatcher.Instance.DispatchEvent(e);
        }
        public void ClearApplyList()
        {
            var e = new BattleUnionOperationEvent(1);
            EventDispatcher.Instance.DispatchEvent(e);
        }
        ...
        /// 打开捐赠装备窗口
        /// </summary>
        public void DepotDonation()
        {
            var e = new BattleUnionDepotOperation(3);
            EventDispatcher.Instance.DispatchEvent(e);
            DepotDonationTip.SetActive(true);
        }
        ...
        {
            DepotDonationTip.SetActive(false);
        }

        /// <summary>
        /// 打开清理窗口
        /// </summary>
        public void OpenDepotClearUp()
        {
            var e = new BattleUnionDepotOperation(4);
            EventDispatcher.Instance.DispatchEvent(e);
            DepotClearUpTip.SetActive(true);
        }

        /// <summary>
        /// 关闭清理窗口
        /// </summary>
        public void CloseDepotClearUp()
        {
            DepotClearUpTip.SetActive(false);
        }

	    /// <summary>
        /// 仓库清理
        /// </summary>
	    public void DepotClearUp()
	    {
            DepotClearUpTip.SetActive(false);
            var e = new BattleUnionDepotOperation(2);
            EventDispatcher.Instance.DispatchEvent(e);
	    }
        ...
        /// 仓库整理
        /// </summary>
	    public void DepotArrange()
	    {
            var e = new BattleUnionDepotOperation(1);
            EventDispatcher.Instance.DispatchEvent(e);
	    }
