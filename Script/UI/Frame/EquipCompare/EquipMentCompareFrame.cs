...
namespace GameUI
{
	...
	catch (Exception ex)
	{
	    ...
	    {                        
	        ...
	        EventDispatcher.Instance.DispatchEvent(new EquipMentCompare_LevelUpEvent());
	    }
        ...
        {
            EventDispatcher.Instance.DispatchEvent(new Close_UI_Event(UIConfig.EquipComPareUI));
            EventDispatcher.Instance.DispatchEvent(new UIEvent_EquipCompare_Donate());
        }

        public void OnClickTakeOut()
        {
            EventDispatcher.Instance.DispatchEvent(new Close_UI_Event(UIConfig.EquipComPareUI));
            EventDispatcher.Instance.DispatchEvent(new UIEvent_EquipCompare_TakeOut());
        }

        public void OnClickRemove()
        {
            EventDispatcher.Instance.DispatchEvent(new Close_UI_Event(UIConfig.EquipComPareUI));
            EventDispatcher.Instance.DispatchEvent(new UIEvent_EquipCompare_Remove());
        }
