    ...
    public class FriendChatCell : MonoBehaviour
    {
        ...
        public void SetTime()
        {
            ...
            else
            {
                ...
                {
                    TimeInfo.text = string.Format("{0}-{1}-{2} 0{3}:{4}", time.Year, time.Month, time.Day, time.Hour, time.Minute);
                }
                else if (time.Minute < 10 && time.Hour >= 10)
                {
                    TimeInfo.text = string.Format("{0}-{1}-{2} {3}:0{4}", time.Year, time.Month, time.Day, time.Hour, time.Minute);
                }
                else if (time.Hour < 10 && time.Minute < 10)
                {
                    TimeInfo.text = string.Format("{0}-{1}-{2} 0{3}:0{4}", time.Year, time.Month, time.Day, time.Hour, time.Minute);
                }
                else
                {
