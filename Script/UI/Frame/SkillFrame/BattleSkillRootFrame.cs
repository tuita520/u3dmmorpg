...
namespace GameUI
{
	public class BattleSkillRootFrame : MonoBehaviour
	{
	    ...
	    private void OnDestroy()
	    {
            ...
            EventDispatcher.Instance.RemoveEventListener(UIEvent_EquipSkillEffect.EVENT_TYPE, PlaySkillEffect);
	    ...
	    private void Start()
	    {
            ...
            EventDispatcher.Instance.AddEventListener(UIEvent_EquipSkillEffect.EVENT_TYPE, PlaySkillEffect);
