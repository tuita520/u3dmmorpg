...
try
{
        ...
        var main = UIManager.Instance.MainUIFrame;
        if (main == null)
        {
            return;
        }
        //var lineConfirmLogicRoot = main.transform.FindChild("LineConfirmRoot");
        //if (lineConfirmLogicRoot != null)
        //{
        //    transform.parent = lineConfirmLogicRoot;
