...
namespace GameUI
{
	public class PayFrame : MonoBehaviour
	{
        ...
        public void BuyKaiFuTeHui()
        {
            var e = new UIEvent_RechargeFrame_OnClick(6);
            EventDispatcher.Instance.DispatchEvent(e);
        }
        ...
        {
            var e = new ShowTipsEvent(1);
            EventDispatcher.Instance.DispatchEvent(e);
        }
        public void OnClickVIPPrivilege()
        {
            var e = new ShowTipsEvent(0);
            EventDispatcher.Instance.DispatchEvent(e);
        }
	...
	try
	{
	        ...
	        if (mHasBindRemoved)
	        {
                ...
                var rewardControllerBase = UIManager.Instance.GetController(UIConfig.RewardFrame);
                if (rewardControllerBase == null)
                {
                    return;
                }
                Binding.SetBindDataSource(rewardControllerBase.GetDataModel(""));
	        }
	...
	//         EventDispatcher.Instance.DispatchEvent(e);
        ...
        public void GetLifeCardReward()
        {
            var e = new GetLifeCardRewardEvent();
            EventDispatcher.Instance.DispatchEvent(e);
        }

        public void BuyLifeCard()
        {
            var e = new UIEvent_RechargeFrame_OnClick(0, -1);
            EventDispatcher.Instance.DispatchEvent(e);
        }
	}
}