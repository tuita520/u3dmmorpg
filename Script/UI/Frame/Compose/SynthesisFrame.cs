...
namespace GameUI
{
	...
	catch (Exception ex)
	{
        ...
        {
            EventDispatcher.Instance.DispatchEvent(new ComposeMenuTabClick(1));
        }
        public void OnClickRune()
        {
            EventDispatcher.Instance.DispatchEvent(new ComposeMenuTabClick(2));
        }
        public void OnClickMountSkill()
        {
            EventDispatcher.Instance.DispatchEvent(new ComposeMenuTabClick(3));
        }
        public void OnClickSkillBook()
        {
            EventDispatcher.Instance.DispatchEvent(new ComposeMenuTabClick(4));
        }
        public void OnClickSkillPiece()
        {
            EventDispatcher.Instance.DispatchEvent(new ComposeMenuTabClick(5));
        }
        public void OnClickMayaShenQi()
        {
            EventDispatcher.Instance.DispatchEvent(new ComposeMenuTabClick(6));
        }
