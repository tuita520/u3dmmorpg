...
namespace GameUI
{
	...
	catch (Exception ex)
	{
		...
		private void NotifyEvent(string eventName,object obj=null)
		{
...
#endif
					{
						MessageNotify(mHits.buffer[b].go, eventName, obj);
						return;
					}
				}
				mHits.Clear();
			...
			else if (hits.Length == 1)
			{
				...
				{
					MessageNotify(hits[0].collider.gameObject, eventName, obj);
				}
			}
		}
		...
		{
			NotifyEvent("OnPress", true);
		}
		public void PressUp()
		{
			NotifyEvent("OnPress", false);
		}
