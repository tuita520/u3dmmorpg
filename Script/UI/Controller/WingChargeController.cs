...
namespace ScriptController
{
    ...
    {
        private WingChargeDataModel DataModel;
        ...
        private void WingChargeCloseBtnClick(IEvent ievent)
        {
            var e = new Close_UI_Event(UIConfig.WingChargeFrame);
            EventDispatcher.Instance.DispatchEvent(e);
        }

        private void WingChargeItemBtnClick(IEvent ievent)
        {
        ...
        private void OnExDataInitData(IEvent ievent)
        {
            RefreshMainUI();
        }
        ...
        private void WingChargebuyBtnClick(IEvent ievent)
        {
        ...
        private void OnFlagInitData(IEvent ievent)
        {
            var tbGift = Table.GetGift(4000);
            if (tbGift == null)
            {
        ...
        private void OnFlagUpData(IEvent ievent)
        {
            var tbGift = Table.GetGift(4000);
            if (tbGift == null)
            {
