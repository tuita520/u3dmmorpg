...
namespace ScriptController
{
    ...
    {
        private static Dictionary<int, int> equipList = new Dictionary<int, int>
        {
            {700, 0},
            {800, 1},
            {900, 2},
        ...
        private PlayerInfoDataModel DataModel;
        private PlayerInfoMsg playerInfoCatch;

        private static int GetEquipIndex(int bagIdandIndex)
        {
            int result;
        ...
        {
            DataModel.Tab = DataModel.Tab == 0 ? 1 : 0;
        }
...
//Tab 
        ...
        public void OnShow()
        {
            ...
            var e = new ShowPlayerInfoTitle(playerInfoCatch.TitleList, "");
            EventDispatcher.Instance.DispatchEvent(e);
        }
