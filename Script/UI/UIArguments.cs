...
{
    public SettingArguments(int tab)
    {
        Tab = tab;
    }
    public int Tab;
...
public class TowerRewardUIArguments : UIInitArguments
{
    public int FubenId { get; set; }
    public int Result { get; set; }
    public int IsFirst { get; set; }
}
public class ModleDisPlayUIArguments : UIInitArguments
{
    public int OkDictId { get; set; }
    public Action OkAction { get; set; }
}
public class OperationActivityTypeUIArguments : UIInitArguments
{
    public int Type { get; set; }
}
public class FieldMineUIArguments : UIInitArguments
{
}
public class ShiZhuangUIArguments : UIInitArguments
{
}

public class ChickenFightUIArgument : UIInitArguments
{
}

public class ChickenRewardUIArgument : UIInitArguments
{
    public int FubenId { get; set; }
...
public class FieldFinalUIArgument : UIInitArguments
{
    public FieldFinalUIArgument(MsgWarFlagInfoList msg)
    {
        _msg = msg;
    }
    public MsgWarFlagInfoList _msg { get; set; }
}
public class SuperVIPUIArgument : UIInitArguments
{
  
}
public class ChickenSceneMapArgument : UIInitArguments
{
